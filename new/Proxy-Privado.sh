...
echo -e " \033[1;33m[ \e[1;31m+~+~+~+~+~+~+\e[1;33m]\033[1;31m\[1;32m100%\033[0m"
sleep 1s
}
clear
echo -e "esta herramienta le cambia y da color al status de \nconexion y agrega una contrasena atu payload para mayor seguridad...."
BARRA="\e[0;31m➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖\e[0m"
echo -e "\e[0;31m➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖\e[0m"
echo ""
...
echo ""
echo -e "\e[1;33minstalando python\e[0m"
fun_bar "apt-get install python -y"
echo -e "\e[1;33minstalando python pip\e[0m"
fun_bar "apt-get install python pip -y"
echo ""
fi
